...
struct AddAppView: View {
    ...
    let availableIcons = [
        "app.fill", "bag.fill", "cart.fill", "book.fill",
        "play.circle.fill", "message.fill", "tv.fill",
        "questionmark.circle.fill", "eye.fill", "music.note",
        "camera.fill", "photo.fill", "map.fill", "bubble.left.fill"
    ]
                ...
                Section {
                    Button(action: {
                        let app = AppItem(
                            ...
                            color: selectedColor,
                            urlScheme: urlScheme,
                            searchUrlTemplate: searchTemplate.isEmpty ? nil : searchTemplate
                        )
                        onAdd(app)
                        dismiss()
                    }) {
